...
extern void si_has_flops; EXPORT_SYMBOL(si_has_flops);
...
extern void si_tcm_size; EXPORT_SYMBOL(si_tcm_size);
...
extern void _robo_dump_vlan_table; EXPORT_SYMBOL(_robo_dump_vlan_table);
extern void bcm_erobo_attach; EXPORT_SYMBOL(bcm_erobo_attach);
extern void bcm_erobo_detach; EXPORT_SYMBOL(bcm_erobo_detach);
...
extern void ccb_miird; EXPORT_SYMBOL(ccb_miird);
extern void ccb_miiwr; EXPORT_SYMBOL(ccb_miiwr);
...
extern void robo_bhdr_register; EXPORT_SYMBOL(robo_bhdr_register);
extern void robo_bhdr_unregister; EXPORT_SYMBOL(robo_bhdr_unregister);
extern void robo_dump_vlan_status; EXPORT_SYMBOL(robo_dump_vlan_status);
extern void robo_eee_advertise_init; EXPORT_SYMBOL(robo_eee_advertise_init);
extern void robo_get_linksts; EXPORT_SYMBOL(robo_get_linksts);
extern void robo_get_portsts; EXPORT_SYMBOL(robo_get_portsts);
extern void robo_permit_fwd_rsv_mcast; EXPORT_SYMBOL(robo_permit_fwd_rsv_mcast);
...
extern void robo_update_agg_group; EXPORT_SYMBOL(robo_update_agg_group);
...
extern void wofa_add; EXPORT_SYMBOL(wofa_add);
extern void wofa_clr; EXPORT_SYMBOL(wofa_clr);
extern void wofa_del; EXPORT_SYMBOL(wofa_del);
extern void wofa_dump; EXPORT_SYMBOL(wofa_dump);
extern void wofa_fini; EXPORT_SYMBOL(wofa_fini);
extern void wofa_init; EXPORT_SYMBOL(wofa_init);
extern void wofa_lkup; EXPORT_SYMBOL(wofa_lkup);
